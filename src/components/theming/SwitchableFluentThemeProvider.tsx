 ...
 */
const SwitchableFluentThemeContext =
  createContext<SwitchableFluentThemeContext>({
 ...
 */
export const SwitchableFluentThemeProvider = (
  props: SwitchableFluentThemeProviderProps
): JSX.Element => {
  const { children, scopeId } = props;
  const [themeStore, setThemeCollection] = useState<ThemeCollection>(
