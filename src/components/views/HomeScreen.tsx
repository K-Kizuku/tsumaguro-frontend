...
export const HomeScreen = (props: HomeScreenProps): JSX.Element => {
  ...
  const defaultDisplayName = localStorageAvailable
    ? getDisplayNameFromLocalStorage()
    : null;
  ...
  const [chosenCallOption, setChosenCallOption] = useState<IChoiceGroupOption>(
    callOptions[0]
  );
  ...
  const buttonEnabled =
    displayName && (startGroupCall || (teamsCallChosen && callLocator));
